...
import 'package:flutter_extension_read/page/HomeDaily.dart';
import 'package:flutter_extension_read/page/HomeRecommend.dart';
      ...
      drawer: new Drawer(
        child: new ListView(
          ...
          children: <Widget>[
            ...
            new ListTile(leading: Icon(Icons.star),title: Text('收藏记录'),),
            new ListTile(leading: Icon(Icons.email),title: Text('关于作者'),),
            new ListTile(leading: Icon(Icons.swap_vertical_circle),title: Text('切换账号'),),
            new AboutListTile(),
          ],
        ),
      ),
